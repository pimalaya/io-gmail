...
use crate::{
    ...
    v1::rest::messages::encode_raw,
    v1::send::{GMAIL_API_BASE, GmailSend, GmailSendError, GmailSendOutput},
};

#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
struct GmailDraftUpdateRequest {
...
impl GmailDraftUpdate {
    pub fn new(
        ...
        let body = GmailDraftUpdateRequest {
            message: DraftMessage {
        ...
        Ok(Self {
            state: State::Send(GmailSend::put_json(http_auth, url, &body)?),
        })
    }
}
